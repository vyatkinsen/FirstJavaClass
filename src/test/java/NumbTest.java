...
class NumbTest {
    ...
    void roundingMath() {
        ...
        Numb t5 = new Numb("30432.00999", 10);
        assertEquals("30432.01", t5.roundingMath(3).getValue());
        Numb t6 = new Numb(-2233.6466, 4);
    ...
    void plus() {
        ...
        assertEquals("-209.12", t7.plus(t8).getValue());
        Numb t9 = new Numb("-122.00044", 3);
        Numb t10 = new Numb(13.3466f, 6);
        assertEquals("-108", t9.plus(t10).getValue());
        ...
        assertEquals("-544488.4472", t15.plus(t16).getValue());
    ...
    void minus() {
        ...
        Numb t11 = new Numb("-0.008010", 10);
        Numb t12 = new Numb("13.3466", 16);
        assertEquals("-13.35461", t11.minus(t12).getValue());
        Numb t13 = new Numb("-167522.900044", 16);
        Numb t14 = new Numb("-544488.3466", 18);
    ...
    void multiplication(){
        ...
        assertEquals("-7237007780", t5.multiplication(t6).getValue());
        Numb t7 = new Numb(2342.00014,10);
        Numb t8 = new Numb(-53452, 7);
        assertEquals("-125184500", t7.multiplication(t8).getValue());
    ...
    void division(){
        Numb t1 = new Numb("12124.00044", 10);
        Numb t2 = new Numb(33.3466, 9);
        assertEquals("363.57531", t1.division(t2).getValue());
        Numb t3 = new Numb(0.0944, 5);
        ...
        Numb t11 = new Numb(-841.0035, 4);
        Numb t12 = new Numb(-25913.0002, 4);
        assertEquals("0.0324", t11.division(t12).getValue());
        Numb t13 = new Numb(99432.1000,14);
        Numb t14 = new Numb(3, 8);
        ...
        Numb t20 = new Numb(-124.45335, 5);
        assertEquals("-1.0043", t19.division(t20).getValue());
